...
export default function Index() {
  ...
  return (
    <div>
      <button onClick={()=>setVisibleNote(true)} className=" bg-[#0c708c] absolute h-20 w-5 right-0 md:top-10 bottom-10 rounded-tl-lg rounded-bl-lg text-white text-3xl">|</button>
      <div className={`${visibleNote ? "" : "hidden"} z-20 p-2 text-lg absolute w-7/12 bg-[#0c708c] bottom-0 md:top-0 right-0 h-4/12 md:h-1/5 rounded md:rounded-bl-xl text-white`}>
