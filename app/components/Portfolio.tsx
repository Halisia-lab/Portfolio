...
export const Portfolio = () => {
    ...
    const mouseOrganoids: Project = { title: "Mouse Organoids Analysis", githubLink: "https://github.com/Halisia-lab/Organoids", description: "An intuitive web application facilitating the analysis of mouse organoids", logoPath: "/images/mouse_organoids/organoids_logo.png", demoLink: "https://www.canva.com/design/DAGTyOGIkik/g8DlQ1Cq4P7bVzs7d75zwA/edit?utm_content=DAGTyOGIkik&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton",screenshots: [] }
